...
from ..core import log, DOMINO_ROOT, RawToHex, HexToRaw
...
class Oracle:
    ...
    def create_engine(account_id, dept_id):
        ...
        engine = create_engine('oracle://', creator = Oracle.ConnectionCreator(database))
        engine.URI = database.uri
        return engine
